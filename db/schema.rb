...
ActiveRecord::Schema.define(version: 2023_01_10_053622) do
  ...
  create_table "lessions", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "l_name"
    t.string "l_desc"
  ...
  create_table "orderdetails", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "sid"
    t.integer "course_id"
    t.string "sname"
    t.string "semail"
